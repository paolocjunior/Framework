...
function cover() {
  return [
    ...
    ...empty(3),
    pCenter("9 camadas de verificacao \u2022 30 commands \u2022 8 agents \u2022 11 hooks", 20, { color: C.secondary }),
...
function sec2_install() {
  return [
    ...
    tbl(["Passo", "Acao", "Detalhe"], [
      ...
      ["2", "\uD83D\uDCC2 Copie para o seu projeto", "Arraste a pasta .claude/ e o arquivo CLAUDE.md para a raiz do seu projeto. E so isso."],
      ["3", "\uD83D\uDD11 De permissao aos scripts", "No Linux ou Mac, rode chmod +x .claude/hooks/*.sh para que os scripts possam ser executados. No Windows com Git Bash, o framework ja cuida disso."],
      ["4", "\uD83D\uDCBB Abra o Claude Code", "Abra o terminal na pasta do projeto e inicie o Claude Code. Ele vai carregar automaticamente as regras e ativar os hooks."],
      ["5", "\u2705 Verifique se esta tudo certo", "Na primeira mensagem, digite /status-check. Se aparecer um resumo do estado do projeto, deu certo."],
    ], [700, 2400, CW - 3100]),
    ...empty(),
    ...
    ...empty(),
    tip("Sem o Codex voce ainda tem o framework completo, mas perde a camada de validacao cross-model (Camada 4). O framework preenche o AGENTS.md automaticamente quando o /spec-check da READY."),
    ...empty(),
...
function sec4_12steps() {
  return [
    ...
    stepTable([
      ...
      ["\uD83E\uDD16 Framework", "Le a spec, procura lacunas, classifica cada problema e da veredicto: READY, READY_WITH_CAVEATS ou NOT_READY."],
      ["\u2705 Sinal de OK", "Veredicto READY. Se vier NOT_READY, lista exatamente o que precisa ser resolvido."],
    ]),
    warn("Se der NOT_READY: nao tente contornar. Responda as perguntas e rode /spec-check de novo. Cada ambiguidade ignorada vira um bug futuro."),
    ...empty(),
    ...
    stepTable([
      ...
      ["\uD83E\uDD16 Framework", "Chama dois agentes em paralelo: um compara plano com spec, outro checa coerencia interna. Devolve APROVADO ou REPROVADO com findings."],
      ["\u2705 Sinal de OK", "Plano APROVADO. O framework cria marker .plan-approved que libera o proximo passo."],
    ]),
    ...
    stepTable([
      ...
      ["\uD83E\uDD16 Framework", "Compara cada requisito da spec com o codigo. Marca MATCH, PARCIAL ou MISS. Usa sensores, behaviours e contratos como evidencia mecanica."],
...
function sec5_hooks() {
  return [
    ...
    p("Enquanto voce trabalha, o framework tem 11 scripts rodando automaticamente. Voce nao precisa chamar nenhum deles \u2014 eles se ativam sozinhos no momento certo."),
    ...empty(),
    h2("\u23F0 Quando cada um dispara"),
    tbl(["Momento", "Quando dispara", "O que acontece"], [
      ["\uD83D\uDE80 Inicio da sessao", "Quando abre ou retoma o Claude Code", "Health check valida que tudo esta instalado"],
      ...
      ["\u2705 Depois de cada edicao", "Assim que o arquivo e salvo", "5 checks rodam: sintaxe, secrets, qualidade, design, determinismo + loop-detection"],
...
function sec12_scenarios() {
  return [
    ...
    numItem("Quando terminar, rode /spec-check. Se der NOT_READY, resolva e tente de novo.", "scenario1"),
    ...
    numItem("Rode /plan-review. Se APROVADO, esta liberado para implementar.", "scenario1"),
    ...
    numItem("Com APROVADO, peca a correcao ao Claude Code.", "scenario2"),
...
function sec13_faq() {
  return [
    ...
    p("Sim. O framework e generico. Os hooks tem checks especificos para Python e JS/TS, mas a camada de regras, comandos e agentes funciona em qualquer stack."),
    ...empty(),
...
function sec14_card() {
  return [
    ...
    tbl(["", "Veredicto", "Acao"], [
      ...
      ["\uD83D\uDFE1", "READY_WITH_CAVEATS / PARCIAL / COM RESSALVAS", "Pode avancar com consciencia dos pontos abertos"],
      ["\uD83D\uDD34", "NOT_READY / REPROVADO / NAO PRONTO / MISS", "Nao avance \u2014 resolva antes"],
    ], [500, 3600, CW - 4100]),
    ...empty(),
    ...
    tbl(["Situacao", "O que fazer"], [
      ...
      ["/plan-review reprovou", "Corrija o plano conforme os findings e rode de novo"],
